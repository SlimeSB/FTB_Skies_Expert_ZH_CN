...
const itemsAndPages = [
  ...
  [["ftbskies:rock", "ftbskies:soil"], "潜行右击草方块或泥土"],
  ...
  ["pneumaticcraft:spawner_core", "副手持有时击杀怪物，它将成为该怪物的刷怪笼核心"],
  ["pneumaticcraft:pcb_blueprint", "可与工程师交易获得 (工作方块为：充气站)"],
  ["elementalcraft:water_shard", "如果你正在为水元素碎片而苦恼, 循环的自动鱼栅可以捕到鱼，您可以将它们从发射器中射出，重新变成鱼类。 击杀它们，它们就有几率掉落水元素碎片",
  ],  [
    [
